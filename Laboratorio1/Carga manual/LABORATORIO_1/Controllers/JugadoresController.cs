...
namespace LABORATORIO_1.Controllers
{
    public class JugadoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "club,apellido,nombre,posicion,compensacion_garantizada")] Jugadores jugadores)
        {
            try
            {
                sw.Restart();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "club,apellido,nombre,posicion,compensacion_garantizada")] Jugadores jugadores)
        {
            try
            {
                sw.Restart();
